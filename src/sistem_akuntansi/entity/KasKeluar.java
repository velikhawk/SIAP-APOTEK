...
public class KasKeluar {
    ...
    private Vector<KasKeluarDetail> kasMasukDetail;
    
    public KasKeluar() {
        this.perkiraan = new Perkiraan();
        this.kasMasukDetail = new Vector<KasKeluarDetail>();
    }
    ...
    public Vector<KasKeluarDetail> getKasKeluarDetail() {
        return kasMasukDetail;
    }

    public void setKasKeluarDetail(Vector<KasKeluarDetail> kasMasukDetail) {
